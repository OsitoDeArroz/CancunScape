        ...
        <>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <TarjetaTour imgSrc={images['itza.png']} title='Xplor Park' description='Emocionante parque de aventuras en la jungla, cavernas y cenotes. Tirolesas, vehículos anfíbios, balsas y ríos subterráneos.' duration='3 hr' price='1350n' link='descripcion' />
